...
class TestBaseDerivativeEstimator:
    """Test _base._BaseDerivativeEstimator."""

    Base = _module._BaseDerivativeEstimator

    class Dummy(Base):
        """Instantiable version of _BaseDerivativeEstimator."""
...
class TestDerivativeEstimatorTemplate:
    ...
    def test_verify(self, k=100):
        ...
        # No plotting.
        errors = dummy.verify(plot=False)
