...
class TestConstantOperator:
    ...
    def test_jacobian(self, n=10):
        ...
        op = opinf.operators.ConstantOperator(np.random.random(n))
        Z = np.zeros((n, n))
...
class TestLinearOperator:
    ...
    def test_init(self):
        ...
        B = np.arange(5)
        op = opinf.operators.LinearOperator(B)
        assert op.shape == (5, 1)
...
class TestQuadraticOperator:
    ...
    def test_init(self):
        ...
        with pytest.raises(ValueError) as ex:
            opinf.operators.QuadraticOperator(Hbad)
        ...
        op = opinf.operators.QuadraticOperator(H)
        assert op.shape == (1, 1)
...
#     """Test operators._nonparametric.CrossQuadraticOperator."""
#     def test_init(self):
...
class TestCubicOperator:
    ...
    def test_init(self):
        ...
        with pytest.raises(ValueError) as ex:
            opinf.operators.CubicOperator(Gbad)
        ...
        op = opinf.operators.CubicOperator(G)
        assert op.shape == (1, 1)
