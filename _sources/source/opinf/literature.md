...
* [**Learning latent representations in high-dimensional state spaces using polynomial manifold constructions**](https://doi.org/10.1109/CDC49753.2023.10384209)  
  ...
  2023 62nd IEEE Conference on Decision and Control (CDC), 2023 <details><summary>BibTeX</summary><pre>@inproceedings{geelen2023latent,
...
&nbsp;&nbsp;doi = {10.1109/CDC56724.2024.10885857},
  ...
  <p></p>
* [**Non-intrusive reduced-order modeling for dynamical systems with spatially localized features**](https://doi.org/10.48550/arXiv.2501.04400)  
  ...
  arXiv, 2025 <details><summary>BibTeX</summary><pre>@article{gkimisis2025spatiallylocal,
...
* [**Guaranteed stable quadratic models and their applications in SINDy and operator inference**](https://arxiv.org/abs/2308.13819)  
  [P. Goyal](https://scholar.google.com/citations?user=9rEfaRwAAAAJ), [I. P. Duff](https://scholar.google.com/citations?user=OAkPFdkAAAAJ), and [P. Benner](https://scholar.google.com/citations?user=6zcRrC4AAAAJ)  
  arXiv, 2023 <details><summary>BibTeX</summary><pre>@article{goyal2023stablequad,
...
* [**Distributed computing for physics-based data-driven reduced modeling at scale: Application to a rotating detonation rocket engine**](https://doi.org/10.48550/arXiv.2407.09994)  
  [I. Farcas](https://scholar.google.com/citations?user=Cts5ePIAAAAJ), R. P. Gundevia, R. Munipalli, and [K. E. Willcox](https://scholar.google.com/citations?user=axvGyXoAAAAJ)  
  arXiv, 2024 <details><summary>BibTeX</summary><pre>@article{farcas2024distributed,
